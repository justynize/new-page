...
// const comfirmPasswordError = document.getElementById('comfirmPasswordError');
...
function validateForm() {
    ...
    // if (comfirmPasswordInput.value !== passwordInput2.value) {
    //     comfirmPasswordError.textContent = 'Passwords do not match.';
    //     valid = false;
    // } else {
...
// comfirmPasswordInput.addEventListener('input', validateForm);
